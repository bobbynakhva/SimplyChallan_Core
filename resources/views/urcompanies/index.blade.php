...
@section('title', 'Manage Company List')
                ...
                <div class="container">
                   <div class="row justify-content-between align-items-center mb-3">
                      ...
                      <div class="col-md-6 text-end" id="mobile_text">
                         <a href="{{ route('urcompanies.create') }}"  class="btn btn-dark"><span><i class="bi bi-plus"></i>Add</span></a>
                      </div>
                   </div>
                               ...
                               <div class="flight__oneway__inner">
                                  <table class="table vertical-middle" id="challanTable">
                                   ...
                                   <td>{{ $company->gstin }}</td>
                                       ...
                                       <form action="{{ route('urcompanies.destroy', $company->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this company?');">
    @csrf
    @method('DELETE')
