      ...
      <div class="row justify-content-center">
         <div class="col-xl-12 col-lg-12">
            <div class="signup__boxes">
               <h4 class="text-center fw-bold">Create Client Company</h4>
               <form action="{{ route('companies.store') }}" method="POST" class="signup__form pt__40">
                  @csrf
                  <div class="row g-4 justify-content-center">
                     <div class="col-lg-6">
                        <div class="input__grp">
                           ...
                           <input type="text" class="form--control @error('industry_name') is-invalid @enderror"
                              id="industry_name" name="industry_name" placeholder="Enter client Industry name">
                           @error('industry_name')
                     ...
                     <div class="col-lg-6">
                        <div class="input__grp">
                           ...
                           <input type="text" class="form--control @error('industry_number') is-invalid @enderror"
                     ...
                     <div class="col-lg-6">
                        <div class="input__grp">
                           <label for="industry_address" class="form-label form--label">Client Address</label>
                              ...
                              name="industry_address" placeholder="Type client Industry address"></textarea>
