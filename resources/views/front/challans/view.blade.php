...
<div class="common__section">
   <div class="container-fluid">
      <div class="divided__common__body">
        ...
        <h4 class="cmn__title text-center" id="mobile_text">
        ...
        <tr>
                ...
                <td colspan="4">
                    <h4>{{ strtoupper($challan->user->name) }}</h4>
                    <p>{{ $challan->user->address }}</p><br>
                    <p>{{ $challan->user->gstin }}</p>
                </td>
                <td >
                ...
                <tbody>
                  <colgroup>
                    ...
                    <tr>
                        ...
                        <td class="text-center">To Parent's Factory</td>
                    </tr>
                    <tr>
                     <th>2.</th>
                        <th>Quantity Returned</th>
                        <td class="text-center">Rod / Finish Good / Semi Finish Good</td>
                    </tr>
                    <tr>
                     <th>3.</th>
                        <th>Waste Scrap Returned</th>
                        <td class="text-center">Generated Scrap</td>
                    </tr>
                    <tr>
                     <th>4.</th>
                        <th>Waste & Scrap Not Recoverable</th>
                        <td class="text-center">Burning Loss / Washing Loss</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="align-items-center gap-3">
                                       ...
                                       <!-- <a href="{{ route('challan.download', ['id' => $challan->id]) }}" class="cmn__btn">
                                          <span>
                                             <i class="material-symbols-outlined">
                                                download
                                             </i>
