             ...
             <section class="flight__onewaysectio pt__60 pb__60">
                <div class="container">
                   <div class="row justify-content-between align-items-center mb-3">
                      <div class="col-md-6">
                         <h3 class="mb-0" id="mobile_text">Manage Purpose</h3>
                      </div>
                      <div class="col-md-6 text-end" id="mobile_text"><!-- class="cmn__btn" -->
                         <a href="{{ route('purposes.create') }}"  class="btn btn-dark"><span><i class="bi bi-plus"></i></span></a>
                      </div>
                   </div>
                                  ...
                                  <table class="table vertical-middle" id="challanTable">
                                     ...
                                     <tbody class="align-middle">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $purpose->name }}</td>
                                            <td>
                                                <a href="{{ route('purposes.edit', $purpose->id) }}" class="btn btn-warning">
